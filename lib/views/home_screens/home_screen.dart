            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  GestureDetector(
                    onTap: () =>
                        Get.toNamed(RoutesName.serviceScreen, arguments: 1),
                    child: Text(
                      'View All',
                      style: SafeGoogleFont(
                        'montserrat',
              ...
              Container(
                // frame239cM (37:737)
                margin:
                    EdgeInsets.fromLTRB(10 * fem, 10 * fem, 18 * fem, 24 * fem),
                width: double.infinity,
                height: 100 * fem,

                child: GetBuilder<AllServicesController>(builder: (controller) {
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return serviceContainer(
                                ...
                                img: controller.serviceListModel[index]
                                    ['image'],
                                name: controller.serviceListModel[index]
                                    ['name']);
                          },
                        );
                }),
              ...
              Expanded(
                child: GetBuilder<BuildingController>(builder: (controller) {
                  return controller.isLoading.value
                      ? const Center(
                      ...
                      : GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return residentalContainer(
                                fem: fem,
                                ffem: ffem,
                                img: controller.buildingModel[index]['image'],
                                name: controller.buildingModel[index]['name'],
                                location: controller.buildingModel[index]
                                    ['city']);
                          },
                        );
                }),
